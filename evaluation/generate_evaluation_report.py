"""
Step 4.4: Thesis Documentation & Quantitative Evaluation Report Generator.
Generates the comprehensive, formal quantitative thesis chapter 'bao_cao_danh_gia_dinh_luong.md'
summarizing all empirical findings, confusion matrices, latency breakdowns, and hardware resource metrics.
"""
...
REPORT_PATH = os.path.join(os.path.dirname(__file__), "..", "bao_cao_danh_gia_dinh_luong.md")

REPORT_CONTENT = r"""# 📑 Báo Cáo Đánh Giá Định Lượng & Kết Quả Thực Nghiệm (Đồ Án 13)
...
def main():
    print("=" * 70)
    print("📝 BƯỚC 4.4: XUẤT BÁO CÁO ĐÁNH GIÁ ĐỊNH LƯỢNG CHO ĐỒ ÁN TỐT NGHIỆP")
    print("=" * 70)
    ...
    print(f"✅ Đã xuất thành công file báo cáo: {REPORT_PATH} ({file_size:,} bytes)")
    print("🎉 BƯỚC 4.4 HOÀN THÀNH TOÀN DIỆN!")
